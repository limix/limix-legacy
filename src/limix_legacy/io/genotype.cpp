...
limix_legacy::CTextfileGenotypeContainer::CTextfileGenotypeContainer(const std::string& filename){
	this->in_filename = filename;
	buffer_size = 100000;
	is_open = false;
}

limix_legacy::CTextfileGenotypeContainer::~CTextfileGenotypeContainer() {
}
