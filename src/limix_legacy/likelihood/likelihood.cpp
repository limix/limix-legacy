...
{
	return limix_legacy::exp( (mfloat_t)(2.0*this->getParams()(0)));
}


mfloat_t CLikNormalSVD::getDelta()
{
	return limix_legacy::exp( (mfloat_t)(2.0*this->getParams()(1)));
}


mfloat_t CLikNormalSVD::getSigmaK2grad()
{
	return 2.0*limix_legacy::exp( (mfloat_t)(2.0*this->getParams()(0)));
}
mfloat_t CLikNormalSVD::getDeltagrad()
{
	return 2.0*limix_legacy::exp( (mfloat_t)(2.0*this->getParams()(1)));
}




} // end:: namespace limix_legacy
